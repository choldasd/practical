    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
				...
				<form id="search" method="get">
					<div class="card-body">
						...
						<a class="btn btn-danger" href="<?php echo e(route('employees.index')); ?>" >Clear</a>
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="text-right"><a href="<?php echo e(route('employees.create')); ?>" class="btn btn-info" >Add Employee</a></div><br>
					<div id="ajax_search">
						<?php echo $__env->make("admin.employees.search", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
					</div>
				</div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\practical\resources\views/admin/employees/index.blade.php ENDPATH**/ ?>