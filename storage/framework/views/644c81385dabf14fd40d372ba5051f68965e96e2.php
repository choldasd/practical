	...
	<tbody class="company_tbody">
		...
		<tr id="tr_<?php echo e($employeeDetail->id); ?>" class="rowtr" rowid="<?php echo e($employeeDetail->id); ?>">
			...
			<td> 
				...
				<a href="javascript:void(0);" action="<?php echo e(route('employee.edit',array($employeeDetail->id))); ?>" class="edit" title="Edit Employee">
						<i class="fa fa-2x fa-pencil-square-o" aria-hidden="true"></i>
				</a>
				
				<a href="javascript:void(0);" action="<?php echo e(route('employee.destroy',array($employeeDetail->id))); ?>" class="delete" title="Delete Employee"><i class="fa fa-2x fa-trash-o" aria-hidden="true"></i></a>
			</td>
		</tr>
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\practical\resources\views/employees/search.blade.php ENDPATH**/ ?>