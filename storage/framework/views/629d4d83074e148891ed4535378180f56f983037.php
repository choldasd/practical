                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(!empty(Auth::guard('admin')->user())): ?>
							...
							<li class="nav-item">
								<a class="nav-link" href="<?php echo e(route('companies.index')); ?>">Company
                                </a>
							</li>							
							<li class="nav-item">
								<a class="nav-link" href="<?php echo e(route('employees.index')); ?>">Employee
                                </a>
							</li>							
...
<?php /**PATH D:\xampp\htdocs\practical\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>