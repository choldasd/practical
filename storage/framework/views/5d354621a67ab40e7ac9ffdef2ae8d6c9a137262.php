    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
				...
				<form id="search" method="get">
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="keyword" id="keyword" placeholder="Name" value="<?php echo e($keyword); ?>">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									...
									<select class="form-control" name="sort_type" id="sort_type">
										...
										<option value="name" <?php if($sort_type == "name"): ?> selected="selected" <?php endif; ?>>Name</option>
									</select>
								</div>
							</div>
							<div class="col-md-3">
						...
						<a class="btn btn-danger" href="<?php echo e(route('companies.index')); ?>" >Clear</a>
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="text-right"><a href="<?php echo e(route('companies.create')); ?>" class="btn btn-info" >Add Company</a></div><br>
					<div id="ajax_search">
						<?php echo $__env->make("admin.companies.search", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
					</div>
				</div>
...
<script src="<?php echo e(url('public/assets/scripts/list.js')); ?>"></script>
<script src="<?php echo e(url('public/assets/scripts/companies.js')); ?>"></script>
<?php $__env->stopPush(); ?>


<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\practical\resources\views/admin/companies/index.blade.php ENDPATH**/ ?>